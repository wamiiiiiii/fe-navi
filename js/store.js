...
const KEYS = {
  ...
  QUIZ_RESULTS:   'fe_quiz_results',
  WEAK_QUESTIONS: 'fe_weak_questions',
  SETTINGS:       'fe_settings',
  READING_TIME:   'fe_reading_time',  // 教科書閲覧時間の記録
  SRS:            'fe_srs',           // 間隔反復学習の問題ごとのステート
};
