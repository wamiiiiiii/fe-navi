...
/**
 * 全演習セッションの累計正答率を計算する
 * @param {Object} quizResults - fe_quiz_resultsのlocalStorageデータ
 ...
 * @param {Object} weakData - fe_weak_questionsのlocalStorageデータ
 ...
 * @param {Object} readingTimeData - fe_reading_timeのデータ（daily_secondsを参照）
 * @param {Object} quizResults - fe_quiz_resultsのデータ（sessionsを参照）
...
/**
 * 直近N日間の正答率を計算する
 * @param {Object} quizResults - fe_quiz_resultsのデータ
 ...
 *
 * @param {Object} readingTimeData - fe_reading_time のデータ
 * @param {Object} quizResults - fe_quiz_results のデータ
 ...
 *
 * @param {Object} quizResults - fe_quiz_results
 ...
 * @param {Object} input.weakData - fe_weak_questions
 * @param {Object} input.progress - fe_progress
