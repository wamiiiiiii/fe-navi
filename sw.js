...
//      OSI参照モデル / SWOT分析 / PDCA / ガントチャート / アジャイル比較 など
//      試験頻出かつ視覚化で学習効果が高いトピックを優先。
//   2) Phase 3 変数トレースUI：
//      - pseudocode.js に renderPseudocodeWithTrace() を追加
//      - 「次へ／前へ／最初から」ボタンで疑似言語コードをステップ実行
//      - 現在の行をハイライト＋変数値の表をリアルタイム更新
//      - quiz.js の問題画面・解説画面の両方で trace_steps があれば自動でトレースUI起動
//      - questions.json の3問にデモ用 trace_steps を追加（calcSum / countEven / nestedLoop）
//
...
//   - A-tech-02 (アルゴリズム・10節): +38問
//   - A-tech-03 (プログラミング言語・8節): +28問
//   - A-tech-04 (ハードウェア・8節): +28問
//   - A-tech-05 (システム構成要素・7節): +23問
//   - A-tech-06 (ハードウェア・組込み・8節): +28問
//   - A-tech-07 (ソフトウェア・6節): +18問
//   - A-tech-08 (マルチメディア・6節): +18問
//   - A-tech-09 (データベース・11節): +43問
//   - A-tech-10 (ネットワーク・10節): +38問
//   - A-tech-11 (情報セキュリティ・15節): +61問
//   - A-tech-12 (システム開発・10節): +38問
//   - A-tech-13 (ソフトウェア開発管理・8節): +28問
//   テクノロジ系117節すべてが 5問以上達成。explanation 平均151字。
